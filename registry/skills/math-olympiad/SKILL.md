...
**The Agent tool cannot enforce tool restriction.** Worker agents get the full tool
...
and omits them will produce worker agents that grind Python for 30 iterations and
