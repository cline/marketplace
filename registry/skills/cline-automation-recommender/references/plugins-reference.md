...
|--------|----------|--------------|
| **plugin-dev** | Building Cline plugins | Skills for creating skills, hooks, commands, agents |
...
- User wants to install Cline automations from Anthropic's official repository or another shared marketplace
