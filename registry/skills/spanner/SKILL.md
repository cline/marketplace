...
Use this skill to execute DML SQL. Please use the googlesql interface for Spanner.
...
Use this skill to execute DQL SQL. Please use the googlesql interface for Spanner.
