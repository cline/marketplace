...
Audit, evaluate, and improve AGENTS.md files across a codebase to ensure Cline has optimal project context.
...
| Global defaults | `user-level Cline instruction files` | User-wide defaults across all projects |
| Package-specific | `./packages/*/AGENTS.md` | Module-level context in monorepos |
| Subdirectory | Any nested location | Feature/domain-specific context |

**Note:** Cline auto-discovers AGENTS.md files in parent directories, making monorepo setups work automatically.
...
| Architecture clarity | High | Can Cline understand the codebase structure? |
...
- **Capture learnings deliberately**: When important project learnings emerge, update AGENTS.md with concise, reusable guidance.
...
- **Global defaults**: Put user-wide preferences in `user-level Cline instruction files`
