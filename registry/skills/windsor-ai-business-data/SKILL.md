...
description: Use when the user needs business data from Windsor.ai connectors for dashboards, reports, analytics, CRM, ecommerce, marketing metrics, financial data, or data integration workflows.
