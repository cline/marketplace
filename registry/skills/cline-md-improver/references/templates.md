...
Describe the project structure so Cline understands where things live.
...
List important files that Cline should know about.
...
4. **Be useful**: Would this help a new Cline session understand the project?
