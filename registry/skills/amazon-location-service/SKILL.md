...
If an AWS MCP server is installed in Cline, use it for AWS documentation, API references, and direct API lookup. Install and configure the AWS MCP server separately when the workflow needs live AWS documentation or resource access.
